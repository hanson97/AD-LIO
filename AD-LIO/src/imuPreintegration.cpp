...
public:
    ...
    TransformFusion()
    {
        ...
        subLaserOdometry = nh.subscribe<nav_msgs::Odometry>("ad_lio/mapping/odometry", 5, &TransformFusion::lidarOdometryHandler, this, ros::TransportHints().tcpNoDelay());
        subImuOdometry   = nh.subscribe<nav_msgs::Odometry>(odomTopic+"_incremental",   2000, &TransformFusion::imuOdometryHandler,   this, ros::TransportHints().tcpNoDelay());

        pubImuOdometry   = nh.advertise<nav_msgs::Odometry>(odomTopic, 2000);
        pubImuPath       = nh.advertise<nav_msgs::Path>    ("ad_lio/imu/path", 1);
    }
...
public:
    ...
    IMUPreintegration()
    {
        subImu      = nh.subscribe<GpsImu7661::ivsensorgps>  (imuTopic,                   2000, &IMUPreintegration::imuHandler,      this, ros::TransportHints().tcpNoDelay());
        subOdometry = nh.subscribe<nav_msgs::Odometry>("ad_lio/mapping/odometry_incremental", 5,    &IMUPreintegration::odometryHandler, this, ros::TransportHints().tcpNoDelay());
    ...
    void imuHandler(GpsImu7661::ivsensorgps imu_raw)
    {
        std::lock_guard<std::mutex> lock(mtx);
        sensor_msgs::Imu thisImu = imuConverterKPQ(imu_raw);
